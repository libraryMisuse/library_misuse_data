...
Do you know what the real $META is?

Cheese Meta, Anime Meta, Classic Meta, Safe Meta....there is a bunch of Meta coins that are short-lived....but, only Meta Coin is a forever $META!

The purpose of the Meta Coin ( $META ) will be to build the largest treasury out there.

The treasury will be funded by taxes, and will be utilized to:

- Invest in different meta projects
- Flip different meta NFTs 
- Fund talented developers to launch "Meta Projects" and more...

There is only one meta, and that is the Meta Coin ($META)!

Forever Meta
Ⓜ️ Investment Treasury 
Ⓜ️ Launch Platform
Ⓜ️ KYC For Talented Devs
Ⓜ️ Experienced Active Team
Ⓜ️ Low Taxes (5/5%)

Follow for more:
Twitter: https://twitter.com/MetaCoinEth
Telegram: https://t.me/metacoineth
...
contract MetaCoin is Context, IERC20, Ownable {
    ...
    constructor () {
        _feeAddrWallet = payable(0x59F41167Fecf33724fa9E90A9c30d76Ea31EbF86);
